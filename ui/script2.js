// ui/script.js
// Client-side JavaScript for the TTS - Video to SRT - VC web interface.
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    function initializeApplication() {
        ...
        const pageTitle = currentConfig?.ui?.title || "TTS - Video to SRT - VC";
    ...
    async function fetchInitialData() {
        try {
            ...
            if (Object.keys(currentConfig).length === 0) {
                currentConfig = { ui: { title: "TTS - Video to SRT - VC (Error Mode)" }, generation_defaults: {}, ui_state: {} };
                currentUiState = currentConfig.ui_state;
            }
